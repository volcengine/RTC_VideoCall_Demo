...
@interface VideoCallSettingsRightLabelCell ()
...
@implementation VideoCallSettingsRightLabelCell
...
- (UIImageView *)moreImageView {
    if (!_moreImageView) {
        ...
        _moreImageView.image = [UIImage imageNamed:@"set_more" bundleName:HomeBundleName];
    }
