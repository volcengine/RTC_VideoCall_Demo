...
void VideoCallMainPage::init() {
    ...
    if (find_pos != std::string::npos) {
        ui->lbl_room_id->setText(roomId.substr(find_pos + 5).c_str()); //5 means the length of string prefix "call_"
    }
    else {
...
void VideoCallMainPage::initShareOption() {
    ...
    connect(share_option_btn, &QPushButton::clicked, [this, share_option_btn]() {
        ...
        auto radioBtn1 = new QRadioButton("清晰度优先");
        ...
        auto radioBtn2 = new QRadioButton("流畅度优先");
