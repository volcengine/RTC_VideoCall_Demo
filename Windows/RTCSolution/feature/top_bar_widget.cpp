...
void TopBarWidget::initContronls() {
    ...
    lbl_setting_->setText(QObject::tr("settings"));
    ...
    auto act_user = new QAction(QObject::tr("user_name"));
    auto act_prv_serv = new QAction(QObject::tr("privacy_policy"));
    auto act_serv_proto = new QAction(QObject::tr("terms_service"));

    auto act_quit = new QAction(QObject::tr("log_out"));
    auto template_func = [=] {
        menu_->hide();
        lbl_setting_->setState(PushButtonWarp::kNormal);
    ...
    connect(act_prv_serv, &QAction::triggered, [=] {
      ...
      QDesktopServices::openUrl(QUrl("https://www.volcengine.com/docs/6348/68918"));

        emit sigPrvServTriggered();
    });
    connect(act_serv_proto, &QAction::triggered, [=] {
        template_func();
          QDesktopServices::openUrl(QUrl("https://www.volcengine.com/docs/6348/70241"));
    ...
    auto act_disclaimer = new QAction(QObject::tr("disclaimer"));
